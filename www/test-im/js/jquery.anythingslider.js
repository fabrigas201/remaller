...
;(function($, win, doc) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNextBackButtons = function() {
			base.$forward = $('<span class="slider-arrow forward"><a href="#"><span>' + o.forwardText + '</span></a></span>');
			base.$back = $('<span class="slider-arrow back"><a href="#"><span>' + o.backText + '</span></a></span>');
